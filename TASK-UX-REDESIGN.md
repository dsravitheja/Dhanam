...
R1–R4, R6, R11–R20, R5/R7/R9 (Phase 4), R26–R30 (Phase 4b), R33–R35/R37 (Phases 8 and 8b), R38–R44 (Phase 9), R45–R48 (Phase 10), R10, R21/6a, R22/6b, R24/6d + 6d-i, R45/6e-ii (Phases 5–6, Waves 0–1), and R49–R54 (Phase 13) have all shipped (see `PHASE-3-REPORT.md`, `PHASE-3B-REPORT.md` — covering 3b and 3c — `PHASE-4-REPORT.md`, `PHASE-4B-REPORT.md`, `PHASE-8-REPORT.md`, `PHASE-8B-REPORT.md`, `PHASE-9-REPORT.md`, `PHASE-10-REPORT.md`, `PHASE-11-REPORT.md`, `PHASE-12-REPORT.md` and `PHASE-13-REPORT.md`). R32/7b has been assessed (recommendation: state-and-don't-model, not build — see Phase 7) but nothing was built, per its own acceptance criteria. What's left is **R8** (Phase 5, not yet started), **R23**/6c and the rest of **R25**/6e (Phase 6), Phase 7 (R31, gated on B10), and Phase 14 (R55–R61, gated on B13 for part of it). Phase numbers link to the full specs below.
